...
const PostCard: React.FC<{ post: CommunityPost }> = ({ post }) => {
    return (
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg dark:shadow-slate-700/50 p-5 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4 whitespace-pre-wrap break-words">{post.content}</p>
            <div className="flex items-center text-sm text-gray-500 dark:text-gray-400 gap-2 border-t border-gray-200 dark:border-slate-700 pt-3">
                <button className="flex items-center gap-1.5 hover:text-primary-600 dark:hover:text-primary-400 transition-colors rounded-md p-2 -m-2 hover:bg-primary-50 dark:hover:bg-slate-700/50">
